...
*/
params [["_position", [],[[]]], ["_className", "",[""]], ["_count", 1,[123]],["_offsetMatrix", [0,0,0],[[]]], ["_offsetDir", 0,[123]], ["_dirNoise", {0},[{}], ["_enableSim", false,[true]];
...
{
	_position select 0 params ["_anchorObject", objNull,[objNull]];
	_position select 1 params ["_anchorPlacement", true, [true]];
