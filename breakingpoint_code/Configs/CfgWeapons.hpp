...
class CfgWeapons 
{
	...
	class BP_Rebel_4_Classic: Uniform_Base
	{
		scope=2;
		displayName="Outlaw level 4 (Bandana+Hat Classic)";
		picture="\breakingpoint_ui\icons\OutlawIcon.paa";
		model="\A3\Characters_F\Common\Suitpacks\suitpack_universal_F.p3d";
		class ItemInfo: UniformItem
		{
	...
	class BP_Hunter_4: Uniform_Base {
		scope=2;
		displayName="Hunter level 4";
		picture="\breakingpoint_ui\icons\HunterIcon.paa";
		model="\A3\Characters_F\Common\Suitpacks\suitpack_universal_F.p3d";
		class ItemInfo: UniformItem {
			uniformModel="-";
	...
	class BP_Survivalist_4_Stone: Uniform_Base {
		scope = 2;
		displayName = "Survivalist level 4 (Stone)";
		picture = "\breakingpoint_ui\icons\SurvivalistIcon.paa";
		model = "\A3\Characters_F\Common\Suitpacks\suitpack_blufor_diver.p3d";
	...
	class BP_Survivalist_4_Classic: Uniform_Base {
		scope = 2;
		displayName = "Survivalist level 4 (Classic)";
		picture = "\breakingpoint_ui\icons\SurvivalistIcon.paa";
		model = "\A3\Characters_F\Common\Suitpacks\suitpack_blufor_diver.p3d";
	...
	class BP_Survivalist_4_Snow: Uniform_Base {
		scope = 2;
		displayName = "Survivalist level 4 (Snow)";
		picture = "\breakingpoint_ui\icons\SurvivalistIcon.paa";
		model = "\A3\Characters_F\Common\Suitpacks\suitpack_blufor_diver.p3d";
	...
	class BP_Scavenger_F: Uniform_Base {
		scope = 2;
