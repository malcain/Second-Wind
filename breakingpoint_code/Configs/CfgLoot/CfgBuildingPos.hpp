...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	class Land_Church_01: GhostHotelAcc
	{
		lootMin = 2;
		lootMax = 4;
		lootPos[] = {{-2.7666,-1.67627,-6.05266},{-3.00732,-0.410889,-6.04109},{6.95264,0.181152,-5.73277},{-5.09277,-1.95288,-3.99316},{3.18457,4.96265,-6.0352},{0.63916,-2.05029,-6.04044},{-0.34668,-0.572021,-6.04747}};
	...
	class Land_Mil_Barracks_L: MilitaryGeneral
	{
		lootMin = 2;
		lootMax = 4;
		lootPos[] = {{-6.54443,6.71631,-1.92283},{-7.16162,4.9707,-1.93552},{-3.23438,6.93164,-1.9304},{-3.89795,5.20264,-1.93352},{0.0952148,7.07764,-1.93958},{-0.575684,5.00342,-1.92963},{3.46973,7.14941,-1.92609},
	...
	class Land_houseV_2T2: Residential2
	{
		lootMin = 2;
		lootMax = 4;
		lootPos[] = {{0.990234,-3.31348,-4.1},{-0.476563,-1.41113,-4.1},{8.0332,-1.40527,-1.33293},{2.35938,-2.05762,-1.29927},{5.50879,-0.56543,-4.1}};
	...
	class Land_HouseV2_01B_dam: Residential
	{
		lootMin = 1;
		lootMax = 2;
		lootPos[] = {{-4.00513,3.22754,-5.14698},{-5.83643,5.08594,-0.7675},{0.830566,0.948242,-0.777229},{2.68115,0.771973,-0.783476},{6.52783,5.92139,-0.773981},{6.70557,2.35938,-0.777351}};
	...
	class Land_HouseV2_03B_dam: Office
	{
		lootMin = 1;
		lootMax = 3;
		lootPos[] = {{0.344727,7.05127,-5.49943},{-2.4248,2.59961,-2.24397},{1.86426,-2.12354,-2.24368},{2.02246,-3.57178,-2.24909},{1.84082,-5.38428,-2.23949},{-2.0791,-1.99561,-2.22883}};
	...
	class Land_DeerStand_02_F: Windmill
	{
		lootMin = 1;
		lootMax = 1;
		lootPos[] = {{0.297119,-1.67383,1.08873}};
	};
...
{{-1.90625,5.05957,2.33805},359.915,0,0.7}
	...
	class Land_i_Barracks_V2_F: MilitaryRanger {
	  lootMin = 3;
	  lootMax = 5;
	...
	class Land_u_Barracks_V2_F: MilitaryRanger {
	  lootMin = 3;
	  lootMax = 5;
...
{{-1.85449,4.89307,2.0395},359.927,0,0.7}
	...
	class Land_d_Stone_Shed_V1_F: Residential {
	  lootMin = 1;
	  lootMax = 2;
	  lootPos[] = {{0.427734,0.12793,0.475418}};
	  zombiePos[] = {};
	};
...
{{0.10376,5.76025,-0.0825281},0.246341,0,0.7}
	...
	class Land_i_Stone_HouseBig_V3_F: Residential {
	  lootMin = 1;
	  lootMax = 3;
	  lootPos[] = {{3.52539,0.94873,-1.51254},{-0.0605469,-0.0961914,1.29747},{-0.513672,2.45166,1.29752},{3.16602,-0.456543,1.29752}};
	  zombiePos[] = {{0.345703,0.87793,-1.41399},{1.69531,0.946777,1.33461}};
	};
...
{{-4.24658,2.5083,2.17496},269.989,0,0.7}
    ...
    class Land_d_Stone_HouseSmall_V1_F: Residential2 {
	 ...
	 class Land_Slum_House02_F: Residential2 {
	  lootMin = 1;
	  lootMax = 2;
	  lootPos[] = {{2.05127,0.0585938,-0.754532},{1.73047,2.6543,-0.766815}};
	  zombiePos[] = {};
	};
