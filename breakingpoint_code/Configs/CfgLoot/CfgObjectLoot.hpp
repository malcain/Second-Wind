...
class CfgObjectLoot {
	...
	class Residential: Default {
		...
		itemType[] =	{
			...
			{"BP_Lupara","weapon"},
			{"BP_Rem870","weapon"},
			{"sgun_HunterShotgun_01_F","weaponNA"},
			{"sgun_HunterShotgun_01_sawedoff_F","weaponNA"},
		...
		itemChance[] =	{
			...
			0.04,   //LUPARA
			0.04,   //REM870
			0.05,   //Hunting shotgun
			0.05,   //Hunting shotgun sawed off
			0.01,	//45ACP
			0.01,	//303B
			0.15,	//22LR
			0.09,	//PAINKILLER
	...
	class Residential2: Default {
		...
		itemChance[] =	{
			...
			0.04,   //Hunting shotgun
			0.04,   //Hunting shotgun sawed off
			0.14,	//S&W 45
			0.01,	//S&W 44
			0.07,	//M1911
			0.05,	//KNIFE
	...
	class WindmillWpn: Default {
		...
		itemChance[] =	{
			...
			0.09,   //RUGER
			0.01,   //1886S
			0.09,   //Hunting shotgun
			0.09,   //Hunting shotgun sawed off
			0.05,   //ENFIELD MKIII
			0.05,   //ENFIELD SCOPED
			0.12,   //ENFIELD OLD
			0.01,   //HA550
