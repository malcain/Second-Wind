...
*/
	...
	class Landuda2_vnitrek: IndustrialSmall
	{
		lootMin = 1;
		lootMax = 3;
		lootPos[] =
...
//Residential//
	...
	class Land_A_Office02: Residential {
	  lootMin = 1;
	  lootMax = 2;	
...
//Supermarket//	
	...
	class Land_A_Pub_01: Supermarket {
	  lootMin = 4;
	  lootMax = 8;		
	...
	class Land_Church_01: Supermarket {
	  lootMin = 1;
	  lootMax = 1;	 
	...
	class Land_Church_03: Supermarket {
	  lootMin = 1;
	  lootMax = 9;	
...
//Farm//	
	class Land_Ind_Workshop01_01: Farm {
	  lootMin = 1;
	  lootMax = 3;	
	...
	class Land_Ind_Workshop01_02: Farm {
	  lootMin = 1;
	  lootMax = 3;	
	...
	class Land_Ind_Workshop01_04: Farm {
	  lootMin = 1;
	  lootMax = 3;	
	...
	class Land_Ind_Workshop01_L: Farm {
	  lootMin = 1;
	  lootMax = 3;		
	...
	class Land_Shed_W01: Farm {
	  lootMin = 1;
	  lootMax = 1;	
	  lootPos[] = {{-1.54102,-0.00390625,-1.41129}};
	};	
		
	class Land_Tovarna2: Farm {
	  lootMin = 5;
	  lootMax = 10;	
	...
	class Land_Ind_Expedice_1: Farm {
	  lootMin = 1;
	  lootMax = 4;	
...
//Medium Value//
	class Land_a_stationhouse: Residential2 {
	  lootMin = 1;
	  lootMax = 6;		
	...
	class Land_wagon_box: Residential2 {
	  lootMin = 1;
	  lootMax = 2;	 
	  lootPos[] = {{0.511719,3.57617,-0.776585},{0.460938,-3.25195,-0.77667}};
	};

	class Land_wagon_flat: Residential2 {
	  lootMin = 1;
	  lootMax = 3;	 
...
//Medium Value// 
	class Land_A_Castle_Bergfrit: Windmill {
	  lootMin = 1;
	  lootMax = 4;	
	...
	class Land_A_Castle_Gate: Windmill  {
	  lootMin = 1;
	  lootMax = 3;	
...
//Other A2 Military Loot//
	class Land_Wreck_Van_F: MilitarySpecial {
	  lootMin = 4;
	  lootMax = 6;		
	...
	class Land_Mil_Barracks_i: MilitaryRanger {
	  lootMin = 1;
	  lootMax = 6;		
	...
	class Land_A_TVTower_Base: MilitaryTower {
	  lootMin = 1;
	  lootMax = 6;		
	...
	class Land_Mil_ControlTower: MilitaryTower {
	  lootMin = 1;
	  lootMax = 6;		
	...
	class Land_UWreck_MV22_F: Stalker {
	  lootMin = 1;
	  lootMax = 6;		
	...
	class Land_misc_deerstand: Residential {
	  lootMin = 1;
	  lootMax = 1;		
