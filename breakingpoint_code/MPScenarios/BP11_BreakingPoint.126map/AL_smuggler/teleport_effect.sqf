...
fn_teleport = {
   ...
   // [] spawn {execVM "AL_smuggler\video_effect.sqf"};
    execVM "AL_smuggler\video_effect.sqf"; call BP_fnc_debugConsoleFormat;
    ...
    sleep 0.5;
    [_unit,[_pozitie select 0,_pozitie select 1,2]] remoteExec ["setPos",_unit]; call BP_fnc_debugConsoleFormat;
    sleep (5 + random 4);
