...
[[_source,_diameter,_flame_sz,_smoke,_briti],"AL_fire\al_fire_deco_SFX.sqf"] remoteExec ["execvm",0,true];

[_source,_diameter,_life_time,false] execvm "AL_fire\al_damage_fire.sqf";
