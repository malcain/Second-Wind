...
emp_dam = 0.1;
list_man_emp = ["Civilian","SoldierGB","SoldierEB","SoldierWB"];
list_car_emp = ["Car", "Motorcycle", "Tank","Air","Ship"];
...
list_light_emp = ["Land_fs_roof_F","Land_fs_sign_F","Land_TTowerBig_2_F","Land_TTowerBig_1_F","Lamps_base_F","PowerLines_base_F","PowerLines_Small_base_F","Land_LampStreet_small_F"];
...
publicVariable "emp_dam"; publicVariable "list_man_emp";publicVariable "list_car_emp";publicVariable "static_turrets_emp";publicVariable "list_light_emp";publicVariable "special_helmet_emp";publicVariable "special_launchers_emp";