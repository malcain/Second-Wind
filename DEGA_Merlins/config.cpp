		...
		class pilotCamera				/// camera for pilot to observe sling loading
        {
            ...
            {		
                class Wide
                {
                    ...
                    visionMode[] 		= {"Normal"};	/// what vision modes are available
            ...
            pilotOpticsShowCursor   = 0; 		//to show aimCursor (is useful to see plane direction)
...
////////////////////////////////////////////////////////////////////////////////	
	class BP_Heli_Transport_02: DEGA_Merlin_Base
	{
	    author = "Deltagamer";
        scope = 2;	
		...
		_generalMacro = "BP_Heli_Transport_02";	
		crew = "B_Helipilot_F";
