...
class RscTitles {
	titles[] = {"TitleScreen", "DeathScreenStart", "DeathScreenEnd", "BP_Combatlog", "BP_VSRedist", "BP_Shutdown", "BP_Ghosting", "BP_Unconscious", "BP_BloodspraySmall", "BP_BloodsprayMedium", "BP_BloodsprayLarge", "Bp_BloodsprayStunned", "BP_Flashbang", "BP_Resting", "BP_AuthFailed", "BP_InvalidVersion", "BP_OutdatedServer", "BP_NoHC", "BP_InvalidAddons", "BP_Rejected", "BP_InvalidName", "BP_NoPlayerID", "BP_ServerNotReady", "BP_Whitelist", "RscTitleStructuredText"};
	...
	class BP_VSRedist {
		...
		class VSRedist : RscPicture {
			x = "0.00001 * safezoneW + safezoneX";
			y = "0.00001 * safezoneH + safezoneY";
			w = "1 * safezoneW";
			h = "1 * safezoneH";
			text = "\breakingpoint_ui\errors\BP_VSRedist.jpg";
		};
	};
	...
	class BP_BuddySystem {
		idd = -1;
		movingEnable = "false";
		duration = 120;
		fadein = 0;
		name = "BuddySystem";
		controls[] = {"BuddySystem"};
		
		class BuddySystem : RscPicture {
			x = "0.00001 * safezoneW + safezoneX";
			y = "0.00001 * safezoneH + safezoneY";
			w = "1 * safezoneW";
			h = "1 * safezoneH";
			text = "\breakingpoint_ui\general\BP_BuddySystem.paa";
		};
	};
	...
	*/
	...
	class BP_NoHC {
		...
		class NoHC : RscPicture {
			x = "0.00001 * safezoneW + safezoneX";
			y = "0.00001 * safezoneH + safezoneY";
			w = "1 * safezoneW";
			h = "1 * safezoneH";
			text = "\breakingpoint_ui\errors\BP_NoHC.jpg";
		};
	};
	...
	class BP_GearSyncFail {
		idd = -1;
		movingEnable = "false";
		duration = 45;
		fadein = 0;
		name = "GearSyncFail";
		controls[] = {"GearSyncFail"};
		
		class GearSyncFail : RscPicture {
			x = "0.00001 * safezoneW + safezoneX";
			y = "0.00001 * safezoneH + safezoneY";
			w = "1 * safezoneW";
			h = "1 * safezoneH";
			text = "\breakingpoint_ui\BP_GearSyncFail.jpg";
		};
	};
