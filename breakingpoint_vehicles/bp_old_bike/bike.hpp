...
{	
	...
	class Bicycle_F: Bicycle
	{
		...
		class EventHandlers
        {
			...
			getin = "_this call BP_fnc_vehicleInteract; (_this select 0) disableCollisionWith (_this select 2);";
			getout = "_this call BP_fnc_vehicleInteract; (_this select 0) disableCollisionWith (_this select 2);";
        };
	};
