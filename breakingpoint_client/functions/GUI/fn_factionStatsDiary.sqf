...
_ctrlScavenger = (_displayFSD displayCtrl 1031);
...
_scavengerPoints = player getVariable ["scavenger",0]; 
...
_ctrlEngineer ctrlSetStructuredText (parseText "n/a");
...
_ctrlScavenger ctrlSetStructuredText (parseText (str _scavengerPoints));
