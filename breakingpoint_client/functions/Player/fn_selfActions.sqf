...
// Allow Use of Suicide Vest

if (_hasSVest and _canDo) then {
	if (s_player_SVest < 0) then {
		s_player_SVest = player addAction ["Detonate Yourself", "\breakingpoint_code\medical\explodePlayer.sqf",[player], 1, false, true, "", ""];
	};
	} else {
