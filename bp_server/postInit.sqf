...
BP_Radio_Ranger = radioChannelCreate [[0.3, 0.3, 1, 0.8], "Ranger", "%UNIT_NAME", []];
BP_Radio_Outlaw = radioChannelCreate [[1, 0, 0, 0.8], "Outlaw", "%UNIT_NAME", []];
BP_Radio_Nomad = radioChannelCreate [[1, 0.55, 0, 0.8], "Nomad", "%UNIT_NAME", []];
BP_Radio_Survivalist = radioChannelCreate [[0, 1, 0, 0.8], "Survivalist", "%UNIT_NAME", []];
BP_Radio_Scavenger = radioChannelCreate [[1, 0.6, 0.2, 0.6], "Scavenger", "%UNIT_NAME", []];
BP_RadioChannels = [BP_Radio_Ranger,BP_Radio_Outlaw,BP_Radio_Nomad,BP_Radio_Survivalist,BP_Radio_Scavenger];

//Broadcast channels
publicVariable "BP_RadioChannels";
...
// Spawn Vehicles
_serverStartup = [] execVM "\bp_server\monitor.sqf";
