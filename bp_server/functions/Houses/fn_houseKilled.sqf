params ["_building", "_killer", "_instigator", "_useEffects"];

//Logging
["houseKilled EH: %1", _this] call BP_fnc_debugConsoleFormat;
...
if (_reinforcement > 0) then
{
	...
	_deleteTypes = ["BP_LootBox","WeaponHolder","WeaponHolderSimulated","BP_Storage"];
