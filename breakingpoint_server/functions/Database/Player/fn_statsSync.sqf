...
private ["_character","_characterID","_kills","_killsH","_headShots","_class","_ranger","_outlaw","_hunter","_nomad","_survivalist","_scavenger","_medical","_currentWpn","_currentAnim","_config","_onLadder","_isTerminal","_temp"];
